...
export default function ContactPage() {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/917816011442?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Nellore, Chejarala, Andhra Pradesh
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} />7816011442
            </p>
            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> guthayaswanth@gmail.com
            </p>
          </div>

          <iframe
          src="https://www.google.com/maps?q=Chejarala,Nellore,Andhra+Pradesh&output=embed"
